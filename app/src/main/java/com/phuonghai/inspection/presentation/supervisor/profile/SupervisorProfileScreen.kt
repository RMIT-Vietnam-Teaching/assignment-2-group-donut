...
//        }
//    }else{
    val fullName by remember { mutableStateOf("John Doe") } //userState?.fullName ?: ""
    val email by remember { mutableStateOf("asdf@rmit.edu.vn") } //userState?.email ?: ""
    val contact by remember { mutableStateOf("0123456789") } //userState?.contact ?: ""
    var message by remember { mutableStateOf("") }
